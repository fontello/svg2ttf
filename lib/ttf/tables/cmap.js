...
function createSubTable0(glyphs) {
  var buf = new ByteBuffer(Uint8Array ? new Uint8Array(262) : new Array(262)); //fixed bug size
...
function createSubTable4(glyphs, segments2bytes) {
  ...
  var buf = new ByteBuffer(Uint8Array ? new Uint8Array(bufSize) : new Array(bufSize)); //fixed bug size
