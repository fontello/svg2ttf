...
var tableDefs = [
  ...
  // gives global information about the font
  {
    ...
    schema: [
      ...
      { name: 'xMin', value: 0, length: 2 }, //TODO: dump value used, check correct value
      { name: 'yMin', value: -151, length: 2 }, //TODO: dump value used, check correct value
      { name: 'xMax', value: 1064, length: 2 }, //TODO: dump value used, check correct value
      { name: 'yMax', value: 850, length: 2 }, //TODO: dump value used, check correct value
  ...
  // consists of a set of metrics that are required by OS/2 and Windows.
  {
    ...
    schema: [
      ...
      { name: 'achVendID', value: 'PfEd', length: 4 },
      ...
      { name: 'sTypoDescender', value: -150, length: 2 },
