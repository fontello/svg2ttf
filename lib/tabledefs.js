...
var tableDefs = [
  ...
  //defines the mapping of character codes to the glyph index values used in the font
  {
    ...
    schema: [
      ...
      { name: 'subTable', value: [
        ...
        //unicode
        { name: 'offset', value: 12, length: 4 },
        //Format 12 subtable
        { name: 'format', value: 12, length: 4 },
        { name: 'length', value: 32, length: 4 },
  ...
  // gives global information about the font
  {
    ...
    schema: [
      ...
      { name: 'checkSumAdjustment', value: 0, length: 4, signed: true }, //TODO: still unclear how to calculate it
      { name: 'magicNumber', value: 0x5F0F3CF5, length: 4},
      { name: 'flags', value: 0x1011, length: 2 }, //TODO: dump value used, check correct value
      { name: 'unitsPerEm', value: 1000, length: 2 }, //TODO: dump value used, check correct value
      { name: 'created', value: 0, length: 8 }, //TODO: use current date
      { name: 'modified', value: 0, length: 8 }, //TODO: use current date
      { name: 'xMin', value: 0, length: 2, signed: true }, //TODO: dump value used, check correct value
      { name: 'yMin', value: -151, length: 2, signed: true }, //TODO: dump value used, check correct value
      { name: 'xMax', value: 1064, length: 2, signed: true }, //TODO: dump value used, check correct value
      { name: 'yMax', value: 850, length: 2, signed: true }, //TODO: dump value used, check correct value
      { name: 'macStyle', value: 0, length: 2 }, //not bold, not italic
      { name: 'lowestRecPPEM', value: 1, length: 8 }, //TODO: check correct value
  ...
  // contains information for horizontal layout
  {
    ...
    schema: [
      { name: 'version', value: 0x10000, length: 4, signed: true },
      { name: 'Ascender', value: 850, length: 4, signed: true }, //TODO: dump value used, check correct value
      { name: 'Descender', value: -151, length: 4, signed: true }, //TODO: dump value used, check correct value
      { name: 'LineGap', value: 90, length: 4, signed: true }, //TODO: dump value used, check correct value
      { name: 'advanceWidthMax', value: 1063, length: 2 }, //TODO: dump value used, check correct value
      { name: 'minLeftSideBearing', value: 0, length: 2, signed: true }, //TODO: dump value used, check correct value
      { name: 'minRightSideBearing', value: -1, length: 2, signed: true }, //TODO: dump value used, check correct value
      { name: 'xMaxExtent', value: 1064, length: 2, signed: true }, //TODO: dump value used, check correct value
      { name: 'caretSlopeRise', value: 1, length: 2, signed: true }, //TODO: dump value used, check correct value
      { name: 'caretSlopeRun', value: 0, length: 2, signed: true }, //TODO: dump value used, check correct value
      ...
      { name: 'numberOfHMetrics', value: 1, length: 2 } //TODO: calculate from htmx table
    ]
  },
  ...
  // establishes the memory requirements for a font.
  {
    ...
    schema: [
      { name: 'version', value: 0x10000, length: 4, signed: true },
      { name: 'numGlyphs', value: 0, length: 2 }, //TODO: calculate it
      { name: 'maxPoints', value: 1, length: 2 }, //TODO: calculate it
      { name: 'maxContours', value: 1, length: 2 }, //TODO: calculate it
      { name: 'maxCompositePoints', value: 0, length: 2 }, //TODO: calculate it
      { name: 'maxCompositeContours', value: 0, length: 2 }, //TODO: calculate it
      { name: 'maxZones', value: 2, length: 2 }, //TODO: dump value used, check correct value
      { name: 'maxTwilightPoints', value: 0, length: 2 }, //TODO: calculate it
      { name: 'maxStorage', value: 0, length: 2 }, //TODO: calculate it
      { name: 'maxFunctionDefs', value: 0, length: 2 }, //TODO: calculate it
      { name: 'maxInstructionDefs', value: 0, length: 2 }, //TODO: dump value used, check correct value
      { name: 'maxStackElements', value: 0, length: 2 }, //TODO: calculate it
      { name: 'maxSizeOfInstructions', value: 0, length: 2 }, //TODO: calculate it
      { name: 'maxComponentElements', value: 0, length: 2 }, //TODO: dump value used, check correct value
  ...
  // allows to include human-readable names for features and settings, copyright notices, font names, style names, and other information related to the font.
  {
    ...
    schema: [
      ...
      { name: 'nameRecordsArray', value: [
        { name: 'platformID', length: 2, value: 0 },
        { name: 'platEncID', length: 2, value: 0 },
        { name: 'languageID', length: 2, value: 0 },
        { name: 'offset', length: 2, value: 0 },
        { name: 'length', length: 2, value: 0 }
      ] },
  ...
  // consists of a set of metrics that are required by OS/2 and Windows.
  {
    ...
    schema: [
      ...
      { name: 'panose', isFixed: true, value: [
      ...
      { name: 'achVendID', value: 0x50664564, length: 4 }, //PfEd
