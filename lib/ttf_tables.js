...
var TTFTables = [
  ...
  // gives global information about the font
  {
    ...
    schema: [
      ...
      //not bold, not italic
      { name: 'lowestRecPPEM', value: 1, length: 8 },
  ...
  // contains information for horizontal layout
  {
    ...
    schema: [
      { name: 'version', value: 0x10000, length: 4, signed: true },
      { name: 'Ascender', value: 850, length: 4, signed: true },
      //TODO: dump value used, check correct value
      { name: 'Descender', value: - 151, length: 4, signed: true },
      //TODO: dump value used, check correct value
      { name: 'LineGap', value: 90, length: 4, signed: true },
      //TODO: dump value used, check correct value
