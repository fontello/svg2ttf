...
function TTF() {
  ...
  function addObject(view, object, schema, offset) {
    var length = 0;
    _.forEach(schema, function (property) {
      if (_.isArray(property.value)) {
        _.forEach(object[property.name].value, function (elem) {
  ...
  function initData(schema) {
    ...
    _.forEach(schema, function (field) {
      ...
      if (_.isArray(field.value)) {
        property = {};
        if (field.required) //single instance of array should be presented
          property.value = initData(field.value);
        else
          property.value = [];
        ...
        property.add = function (value) {
          if (_.isArray(value))
            this.value = _.union(this.value, value);
          else
