...
function generateTTF(font) {
  ...
  _.forEach(font.glyphs, function(glyph) {
    glyph.ttfContours = utils.simplify(glyph.ttfContours);
    glyph.ttfContours = utils.simplify(glyph.ttfContours); // one pass is not enougth
    glyph.ttfContours = utils.interpolate(glyph.ttfContours);
