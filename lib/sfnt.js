...
//getters and setters
  ...
  Object.defineProperty(this, 'lineGap', {
    get: function () {
      return parseInt(!_.isUndefined(this.int_lineGap) ? this.lineGap : ((this.ascent - this.descent) * 0.09), 10);
    },
    set: function (value) {
  ...
  Object.defineProperty(this, 'underlinePosition', {
    get: function () {
      return parseInt(!_.isUndefined(this.int_underlinePosition) ? this.underlinePosition : ((this.ascent - this.descent) * 0.01), 10);
    },
    set: function (value) {
