...
//getters and setters
  ...
  Object.defineProperty(this, 'minRsb', {
    get: function () {
      var hasPoints = false;
      var result = 0;
      _.forEach(this.glyphs, function(glyph) {
        ...
        _.forEach(glyph.contours, function(contour) {
          ...
          var rsb = glyph.width - (glyph.lsb || 0) - (xMax - xMin);
          if (rsb < result) {
            result = rsb;
          }
    ...
    get: function () {
      ...
      _.forEach(this.glyphs, function(glyph) {
        if (glyph.contours && glyph.contours.length > 0) {
          hasContours = true;
          if (glyph.width > result) {
            result = glyph.width;
          }
        }
      });
      return hasContours ? result : 0;
    }
  });
    ...
    get: function () {
      ...
      _.forEach(this.glyphs, function(glyph) {
        ...
        _.forEach(glyph.contours, function(contour) {
          ...
          var extent = (glyph.lsb || 0) + xMax - xMin;
          if (extent > result) {
            result = extent;
          }
      ...
      return hasPoints ? result : this.width;
    }
  });
