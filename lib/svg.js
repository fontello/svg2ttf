...
function load (str) {
  ...
  // xmldom@0.9.x rejects XML declarations that are not at the very start.
  // Trim surrounding whitespace to keep compatibility with historical svg2ttf inputs.
  // TODO: remove in next major version.
  var doc = (new DOMParser()).parseFromString(str.trim(), 'application/xml')
