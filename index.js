...
function svg2ttf(svgString, options) {
  ...
  font.sfntNames.push({ id: 6, value: options.psname || (options.fullname || svgFont.id).replace(/[\s\(\)\[\]<>%\/]/g, '').substr(0, 62) }); // Postscript name for the font, required for OSX Font Book

  font.sfntNames.push({ id: 7, value: options.trademark || '' }); // Trademark
  font.sfntNames.push({ id: 8, value: options.manufacturer || '' }); //Manufacturer
  font.sfntNames.push({ id: 9, value: options.designer || '' }); // Designer
  font.sfntNames.push({ id: 10, value: options.description || 'Generated by svg2ttf from Fontello project.' }); //Description
  font.sfntNames.push({ id: 11, value: options.urlvendor || 'http://fontello.com' }); //URL vendor
  font.sfntNames.push({ id: 12, value: options.urldesigner || '' }); // URL Designer
  font.sfntNames.push({ id: 13, value: options.license || '' }); // license
  font.sfntNames.push({ id: 14, value: options.licenseUrl || '' }); // license Url
  font.sfntNames.push({ id: 15, value: options.preferredfamily || '' }); //Preferred Family
  font.sfntNames.push({ id: 17, value: options.macname || '' }); // Mac Name
